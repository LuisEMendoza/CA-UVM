...
![a) Sistema en cascada](Media/SistemaEnSerie.png){fig-align="center"}

![b) Sistema en paralelo](Media/SistemaEnParalelo.png){fig-align="center"}

![c) Sistema en lazo cerrado](Media/SistemaRealimentado.png){fig-align="center"}
...
![Resortes en paralelo](Media/ResortesParalelo.png){fig-align="center"}
...
![Resortes en serie](Media/ResortesSerie.png){fig-align="center"}
...
![Amortiguadores en paralelo](Media/AmortiguadorParalelo.png){fig-align="center"}
...
![Amortiguadores en serie](Media/AmortiguadorSerie.png){fig-align="center"}
...
![Sistema masa-resorte-amortiguador 1](Media/SistemaMasaResorteAmortiguador1.png){fig-align="center"}
...
Siendo $a$ la aceleración, por ende, la segunda derivada del desplazamiento.

##### Ejemplo 2

Obtener la función de transferencia del sistema mecánico:

![Sistema masa-resorte-amortiguador 2](Media/SistemaMasaResorteAmortiguador2.png){fig-align="center"}
